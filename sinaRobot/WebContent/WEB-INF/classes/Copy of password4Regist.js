(function() {
	function RegController() {
		...
		this.setRegisterCallback = function(a) {
			typeof a == "function" ? me.registerCallback = a
					: me.registerCallback = $.funcEmpty
		};
		this.setVerifyCallback = function(a) {
			typeof a == "function" ? me.verifyCallback = a
					: me.verifyCallback = $.funcEmpty
		};
		this.setBeforeDialogShow = function(a) {
			typeof a == "function" ? me.beforeDialogShow = a
					: me.beforeDialogShow = $.funcEmpty
		};
		this.setSubmitUrl = function(a) {
			me.formPostUrl = a
		};
		this.setFormData = function() {
			var a = me.getVerifyData(), b = $.core.json.merge(
					me.getExtraData(), a), c = $.E(me.formId), d = $.core.json
					.merge(me.getPostData(), b), e = window.$CONFIG || {};
		...
		this.getVersion = function(a) {
			...
			if (b) {
				...
				$.kit.io.jsonp(
						{
							url : "http://" + accDomain
									+ "/signup/v5/getjsversion",
							onComplete : function(b) {
								if (b.code == "100000" && b.data
										&& b.data.version) {
									me.jsVersion = b.data.version;
									$.cookie.set("WB_register_version",
											b.data.version, {
												encode : !1
											});
									a()
		...
		this.loadLayerJs = function() {
			...
			if (window.WBRegLayer)
				a();
			else {
				var b = me.getJsPath()
						+ "register/js/page/remote/registerLayer.js?version="
						+ me.jsVersion;
				$.scriptLoader({
					url : b,
					onComplete : a,
		...
		this.checkLoadLanguage = function() {
			var a = arguments.callee, b = function() {
		...
		this.feedBackUrlCallBack = function(json) {
			...
			if (code == "100000") {
				...
				if (json.checktype) {
					...
					json.validateExtra ? me.verifyCallback(json) : me
	...
	if (!STK)
		var STK = function() {
			...
			a[b] = {
				...
				E : function(a) {
					return typeof a == "string" ? document.getElementById(a)
							: a
				},
				C : function(a) {
					var b;
					...
					a == "TEXT" ? b = document.createTextNode("")
							: a == "BUFFER" ? b = document
									.createDocumentFragment() : b = document
									.createElement(a);
					return b
				},
				log : function(a) {
			...
			var l = function() {
				...
				if (f < d.duration) {
					h = a.core.ani.algorithm.compute(d.animationType, 0,
							d.distance, f, d.duration, d.extra,
							d.algorithmParams);
					b(h);
			...
			.register(
					...
					function(a) {
						var b = function(a) {
							...
							trident : "-ms-",
							gecko : "-moz-"
						}[a.core.util.browser.CORE], e = [ "transform",
	...
	STK.register("core.arr.foreach", function(a) {
		...
		return function(d, e) {
			return a.core.arr.isArray(d) || d.length && d[0] !== undefined ? b(
					d, e) : typeof d == "object" ? c(d, e) : null
		}
	});
	...
	STK.register("core.json.merge", function(a) {
		var b = function(b) {
			return b === undefined ? !0 : b === null ? !0
					: a.core.arr.inArray(typeof b, [ "number", "string",
							"function", "boolean" ]) ? !0 : a.core.dom
							.isNode(b) ? !0 : !1
		}, c = function(d, e, f) {
			if (b(f))
				d[e] = f;
							...
							defaultColor : function(a, b, c, d, e) {
								var f = Math.max(0, Math.min(255, Math.ceil(a
										* (c.getR() - b.getR()) + b.getR()))), g = Math
										.max(0, Math.min(255, Math.ceil(a
												* (c.getG() - b.getG())
												+ b.getG()))), h = Math.max(0,
										Math.min(255, Math.ceil(a
												* (c.getB() - b.getB())
												+ b.getB()))), i = {};
								i[j(e)] = "#" + (f < 16 ? "0" : "")
	...
	STK.register("core.dom.removeClassName", function(a) {
		return function(b, c) {
			b.nodeType === 1
					...
					&& (b.className = b.className.replace(new RegExp("(^|\\s)"
							+ c + "($|\\s)"), " "))
		}
	});
	STK.register("core.evt.addEvent", function(a) {
		return function(b, c, d) {
			...
			if (typeof d != "function")
				return !1;
			b.addEventListener ? b.addEventListener(c, d, !1)
					...
					function(a) {
						...
						var i = function(a, b, c, e) {
							...
							if (h.length > 1 && k.exec(a))
								...
								if (!e && h.length > 1 && b.nodeType === 9
										&& !s && j.match.ID.test(h[0])
								...
								if (b) {
									u = e ? {
										...
										set : n(e)
											...
											&& (h[0] === "~" || h[0] === "+")
											&& b.parentNode ? b.parentNode : b,
											s);
									m = u.expr ? i.filter(u.expr, u.set)
											: u.set;
						...
						i.contains = document.compareDocumentPosition ? function(
								a, b) {
	...
	STK.register("core.dom.insertAfter", function(a) {
		return function(a, b) {
			var c = b.parentNode;
			c.lastChild == b ? c.appendChild(a) : c.insertBefore(a,
					b.nextSibling)
		}
	});
	...
	STK.register("core.dom.neighbor", function(a) {
		var b = function(b, c, d) {
			...
			var d = c, e = {
				...
				child : function(b) {
					d = (b ? a.core.dom.sizzle(b, d)[0] : a.core.dom
							.firstChild(d))
							|| d;
					return e
				},
	...
	STK.register("core.dom.uniqueID",
			function(a) {
				return function(b) {
					return b
							&& (b.uniqueID || (b.uniqueID = a.core.util
									.getUniqueKey()))
				}
			});
							...
							for (var k = j.length - 1; k > -1 && j[k]; k--) {
								...
								if (l && l.apply)
									try {
										...
										a.log("[error][custEvent]" + n.message,
												n, n.stack)
									}
							}
					...
					hook : function(a, e, g) {
						if (!(!a || !e || !g)) {
							...
							if (l) {
								...
								var p = function(a) {
									var b = !0;
									h(e, o[a.type].type, Array.prototype.slice
											.apply(arguments, [ 1,
													arguments.length ]),
											function() {
												b = !1
					...
					function(a) {
						...
						return function(c, d) {
							...
							if (d == null)
								...
								if (d.nodeType == 1) {
									var f = b(d);
									return e.right > f.left && e.left < f.right
											&& e.bottom > f.top
											&& e.top < f.bottom ? !0 : !1
								}
								if (d.clientX == null)
							...
							var g = a.core.util.scrollPos(), h = d.clientX
									+ g.left, i = d.clientY + g.top;
							return h >= e.left && h <= e.right && i >= e.top
									&& i <= e.bottom
						}
					});
						...
						return function(a, b) {
							return a
									.replace(
											/#\{(.+?)\}/ig,
											function() {
												var a = arguments[1].replace(
														/\s/ig, ""), c = arguments[0], d = a
														.split("||");
	...
	STK
			.register(
					"core.io.require",
					function(a) {
						var b = "http://js.t.sinajs.cn/STK/js/", c = function(
								a, b) {
	...
	STK.register("core.json.compare", function(a) {
		return function(b, c) {
			return a.core.json.include(b, c) && a.core.json.include(c, b) ? !0
					: !1
		}
	});
	STK
					...
					function(a) {
						return function(b) {
							var c = b.getAttribute("name"), d = b
								...
								b === !1 ? f = !1
										: f.value ? f.value = [ a.core.str
												.trim(b || "") ]
												.concat(f.value)
												: f.value = a.core.str.trim(b
														|| "")
							};
							if (!!b.disabled || !c)
								return !1;
							...
							case "BUTTON":
							default:
								g(b.value || b.getAttribute("value")
										|| b.innerHTML || !1)
							}
							return f
						}
						...
						var m = function(b, c) {
							...
							if (!!s(h, f)) {
								...
								var k = 3e3, l = function() {
									if (parseInt(a.core.dom.getStyle(j,
											"height")) == 42) {
										a.core.util.hideContainer
												.removeChild(j);
										t(h)
									} else if (--k > 0)
										setTimeout(l, 10);
			...
			.register(
					...
					function(a) {
						var b = {
							...
							en : "en-us",
							"en-us" : "en-us"
						}, c = "http://js.t.sinajs.cn/t5/lang/jsv5registercheck/mo/", d = function(
								d) {
							d = a.parseParam({
								lang : "zh-cn",
							...
							var e = d.lang, f = d.loadFinish, g = d.loadTimeout;
							if (e == "zh-cn")
								f();
							else {
								var h = function() {
	...
	var $ = STK, accDomain = window.location.host == "www.weibo.com" ? "www.weibo.com"
			: "weibo.com";
	...
	var RSAKey = function() {
		...
		function G(a) {
			...
			for (c = 0; c < b.t - 1; ++c) {
				...
				if ((a[c + b.t] += b.am(c + 1, 2 * b[c], a, 2 * c + 1, d, b.t
						- c - 1)) >= b.DV) {
					a[c + b.t] -= b.DV;
					a[c + b.t + 1] = 1
				}
			...
			a != null
					&& ("number" == typeof a ? this.fromNumber(a, b, c)
							: b == null && "string" != typeof a ? this
									.fromString(a, 256) : this.fromString(a, b))
		}
