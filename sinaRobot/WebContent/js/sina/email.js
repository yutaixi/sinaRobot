...
STK.register("core.ani.algorithm", function(a) {
	var b = {
		...
		easeoutcubic : function(a, b, c, d, e) {
			return (a /= d / 2) < 1 ? c / 2 * a * a * a + b : c / 2
					* ((a -= 2) * a * a + 2) + b
		},
		...
		easeinoutback : function(a, b, c, d, e) {
			e == undefined && (e = 1.70158);
			return (a /= d / 2) < 1 ? c / 2 * a * a
					* (((e *= 1.525) + 1) * a - e) + b : c / 2
					* ((a -= 2) * a * (((e *= 1.525) + 1) * a + e) + 2) + b
		}
	};
	return {
		addAlgorithm : function(a, c) {
			if (b[a])
				throw "[core.ani.tweenValue] this algorithm :" + a
						+ "already exist";
			b[a] = c
		},
...
STK.register("core.obj.parseParam", function(a) {
	return function(a, b, c) {
		...
		for (d in a) {
			e[d] = a[d];
			b[d] != null
					&& (c ? a.hasOwnProperty[d] && (e[d] = b[d]) : e[d] = b[d])
		}
		return e
	}
});
STK.register("core.ani.tweenArche", function(a) {
	return function(b, c) {
		...
		var l = function() {
			f = +(new Date) - g;
			if (f < d.duration) {
				h = a.core.ani.algorithm.compute(d.animationType, 0,
						d.distance, f, d.duration, d.extra, d.algorithmParams);
				b(h);
...
STK
		.register(
				...
				function(a) {
					...
					try {
						/windows|win32/i.test(b) ? h = "windows" : /macintosh/i
								.test(b) ? h = "macintosh" : /rhino/i.test(b)
								&& (h = "rhino");
...
STK.register("core.dom.cssText",
		function(a) {
			var b = function(a) {
				var b = 0, c = [], d = "close", e = !1, f = null, g = function(
						d) {
					c.push({
						type : "info",
						content : a.slice(0, b)
				...
				trident : "-ms-",
				gecko : "-moz-"
			}[a.core.util.browser.CORE], e = [ "transform", "transform-origin",
					...
					"animation-timing-function" ], f = function(a) {
...
STK
		.register("core.arr.foreach",
				function(a) {
					...
					return function(d, e) {
						return a.core.arr.isArray(d) || d.length
								&& d[0] !== undefined ? b(d, e)
								: typeof d == "object" ? c(d, e) : null
					}
				});
...
STK.register("core.json.merge", function(a) {
	var b = function(b) {
		return b === undefined ? !0 : b === null ? !0 : a.core.arr.inArray(
				typeof b, [ "number", "string", "function", "boolean" ]) ? !0
				: a.core.dom.isNode(b) ? !0 : !1
	}, c = function(d, e, f) {
		if (b(f))
			d[e] = f;
		else {
...
STK
		.register(
				"core.util.color",
				function(a) {
					var b = /^#([a-fA-F0-9]{3,8})$/, c = /^rgb[a]?\s*\((\s*([0-9]{1,3})\s*,){2,3}(\s*([0-9]{1,3})\s*)\)$/, d = /([0-9]{1,3})/ig, e = /([a-fA-F0-9]{2})/ig, f = a.core.arr.foreach, g = function(
							a) {
						var g = [], h = [];
						if (b.test(a)) {
							h = a.match(b);
							h[1].length <= 4 ? g = f(h[1].split(""), function(
									a, b) {
								return parseInt(a + a, 16)
							}) : h[1].length <= 8
									&& (g = f(h[1].match(e), function(a, b) {
...
STK
		.register(
				"core.ani.tween",
				function(a) {
					var b = a.core.ani.tweenArche, c = a.core.arr.foreach, d = a.core.dom.getStyle, e = a.core.func.getType, f = a.core.obj.parseParam, g = a.core.json.merge, h = a.core.util.color, i = function(
							a) {
						...
						for (var b = 0, c = a.length; b < c; b += 1) {
							...
							if (d > 64 && d < 90) {
								var e = a.substr(0, b), f = a.substr(b, 1), g = a
										.slice(b + 1);
						...
						defaultColor : function(a, b, c, d, e) {
							var f = Math.max(0, Math.min(255, Math.ceil(a
									* (c.getR() - b.getR()) + b.getR()))), g = Math
									.max(0, Math
											.min(255, Math.ceil(a
													* (c.getG() - b.getG())
													+ b.getG()))), h = Math
									.max(0, Math
											.min(255, Math.ceil(a
													* (c.getB() - b.getB())
													+ b.getB()))), i = {};
							i[j(e)] = "#" + (f < 16 ? "0" : "")
									+ f.toString(16) + (g < 16 ? "0" : "")
									+ g.toString(16) + (h < 16 ? "0" : "")
									+ h.toString(16);
							return i
						},
					...
					return function(d, e) {
						...
						m = function(a) {
							var b = [], e = c(n, function(b, c) {
								var d;
								j[c] ? d = j[c]
										: b.defaultColor ? d = j.defaultColor
												: d = j["default"];
						...
						var v = function(a) {
							...
							if (s.getStatus() !== "play") {
								...
								o = a.core.dom.cssText(d.style.cssText
										+ (e.staticStyle || ""));
								s.play()
							} else
								r.push({
...
STK.register("core.dom.addClassName", function(a) {
	return function(b, c) {
		b.nodeType === 1
				&& (a.core.dom.hasClassName(b, c) || (b.className = a.core.str
						.trim(b.className)
						+ " " + c))
	}
});
STK.register("core.dom.removeClassName", function(a) {
	return function(b, c) {
		b.nodeType === 1
				...
				&& (b.className = b.className.replace(new RegExp("(^|\\s)" + c
						+ "($|\\s)"), " "))
	}
});
STK.register("core.evt.addEvent", function(a) {
	return function(b, c, d) {
		...
		if (typeof d != "function")
			return !1;
		b.addEventListener ? b.addEventListener(c, d, !1) : b.attachEvent ? b
				.attachEvent("on" + c, d) : b["on" + c] = d;
		return !0
	}
});
STK.register("core.evt.removeEvent", function(a) {
	return function(b, c, d) {
		...
		if (typeof d != "function")
			return !1;
		b.removeEventListener ? b.removeEventListener(c, d, !1) : b.detachEvent
...
STK.register("core.ani.transition", function(a) {
	var b = function() {
		var a = document.createElement("style"), b = "STK_transition_"
				+ +(new Date), c = null, d = {};
		...
		d.addRule = function(a, b) {
			...
			c.addRule ? c.addRule(a, b, d.length) : c.insertRule
					&& c.insertRule(a + " {" + b + "}", d.length)
		};
		d.destory = function() {
	...
	return function(c, d) {
		...
		}, d), f = "all " + e.duration + "ms cubic-bezier("
				+ e.timingFn.join(",") + ")", g = a.core.dom
				.cssText(c.style.cssText), h = "test", i = b();
		g.merge(e.target);
		g.push("transition", f);
...
STK.register("core.arr.clear", function(a) {
	return function(b) {
		...
		for (var d = 0, e = b.length; d < e; d += 1)
			a.core.arr.findout([ undefined, null, "" ], b[d]).length
					|| c.push(b[d]);
		return c
	}
});
				...
				function(a) {
					...
					var i = function(a, b, c, e) {
						...
						if (h.length > 1 && k.exec(a))
							...
							if (!e && h.length > 1 && b.nodeType === 9 && !s
									&& j.match.ID.test(h[0])
									&& !j.match.ID.test(h[h.length - 1])) {
								u = i.find(h.shift(), b, s);
								b = u.expr ? i.filter(u.expr, u.set)[0]
										: u.set[0]
							}
							if (b) {
								u = e ? {
									expr : h.pop(),
									set : n(e)
								} : i.find(h.pop(), h.length === 1
										&& (h[0] === "~" || h[0] === "+")
										&& b.parentNode ? b.parentNode : b, s);
					...
					i.filter = function(a, b, c, d) {
						var e = a, f = [], g = b, h, k, l = b && b[0]
								&& i.isXML(b[0]);
						while (a && b.length) {
							for ( var m in j.filter)
								if ((h = j.leftMatch[m].exec(a)) != null
										&& h[2]) {
					...
					var j = {
						...
						preFilter : {
							...
							PSEUDO : function(a, b, c, e, f) {
								...
								else if (j.match.POS.test(a[0])
										|| j.match.CHILD.test(a[0]))
									return !0;
								return a
							},
							POS : function(a) {
						...
						filter : {
							...
							ATTR : function(a, b) {
								var c = b[1], d = j.attrHandle[c] ? j.attrHandle[c]
										(a)
										: a[c] != null ? a[c] : a
												.getAttribute(c), e = d + "", f = b[2], g = b[4];
								return d == null ? f === "!="
										: f === "=" ? e === g
												: f === "*=" ? e.indexOf(g) >= 0
														: f === "~=" ? (" " + e + " ")
					...
					for ( var m in j.match) {
						j.match[m] = new RegExp(j.match[m].source
								+ /(?![^\[]*\])(?![^\(]*\))/.source);
						j.leftMatch[m] = new RegExp(/(^(?:.|\r|\n)*?)/.source
								+ j.match[m].source.replace(/\\(\d+)/g, l))
					}
					var n = function(a, b) {
					...
					var p;
					document.documentElement.compareDocumentPosition ? p = function(
							a, b) {
						...
						return c
							...
							: "sourceIndex" in document.documentElement ? p = function(
									a, b) {
					...
					i.contains = document.compareDocumentPosition ? function(a,
							b) {
...
STK.register("core.dom.trimNode", function(a) {
	return function(a) {
		...
		for (var c = b.length - 1; c >= 0; c -= 1)
			b[c] && (b[c].nodeType == 3 || b[c].nodeType == 8)
					&& a.removeChild(b[c])
	}
});
...
STK.register("core.dom.position", function(a) {
	var b = function(b) {
		...
		if (a.core.util.browser.OPERA != -1 || a.core.util.browser.SAFARI != -1
...
STK.register("core.dom.cascadeNode", function(a) {
	return function(b) {
		...
		c.toggle = function() {
			b.style.display === "none" ? b.style.display = d
...
STK.register("core.dom.insertElement", function(a) {
	return function(b, c, d) {
		...
		case "beforeend":
			...
			break;
		case "afterend":
			b.nextSibling ? b.parentNode.insertBefore(c, b.nextSibling)
		...
		.register(
				...
				function(a) {
					var b = [], c = !1, d = a.core.func.getType, e = a.core.util.browser, f = a.core.evt.addEvent, g = function() {
						return !c && document.readyState === "complete" ? !0
								: c
					}, h = function() {
						if (c != !0) {
							c = !0;
...
STK.register("core.dom.neighbor", function(a) {
	var b = function(b, c, d) {
		...
		var d = c, e = {
			...
			child : function(b) {
				d = (b ? a.core.dom.sizzle(b, d)[0] : a.core.dom.firstChild(d))
						|| d;
				return e
			},
...
STK.register("core.dom.toggleClassName", function(a) {
	return function(b, c) {
		a.core.dom.hasClassName(b, c) ? a.core.dom.removeClassName(b, c)
...
STK
		.register(
				"core.evt.custEvent",
				function(a) {
					var b = "__custEventKey__", c = 1, d = {}, e = function(a,
							c) {
								...
								for (var k = j.length - 1; k > -1 && j[k]; k--) {
									...
									if (l && l.apply)
										try {
											...
											a.log("[error][custEvent]"
													+ n.message, n, n.stack)
										}
								}
								g && a.core.func.getType(f) === "function"
										&& f();
								return i.key
							}
						}
...
STK.register("core.evt.fixEvent", function(a) {
	...
	return function(b) {
		...
		if (b.pageX == null && b.clientX != null) {
			...
			b.pageX = b.clientX + (c.scrollLeft || d && d.scrollLeft || 0)
					- (c.clientLeft || d && d.clientLeft || 0);
			b.pageY = b.clientY + (c.scrollTop || d && d.scrollTop || 0)
					- (c.clientTop || d && d.clientTop || 0)
		}
		!b.which
				&& b.button
				&& (b.button & 1 ? b.which = 1 : b.button & 4 ? b.which = 2
						: b.button & 2 && (b.which = 3));
		b.relatedTarget === undefined
				&& (b.relatedTarget = b.fromElement || b.toElement);
...
STK.register("core.evt.delegatedEvent", function(a) {
	...
	return function(c, d) {
		...
		h.fireInject = function(b, d, f) {
			var g = b.getAttribute("action-type"), h = b
					.getAttribute("action-data");
			g && e[d] && e[d][g] && e[d][g]({
				evt : f,
				el : b,
		...
		.register(
				...
				function(a) {
					...
					return function(c, d) {
						if (typeof d != "string")
							throw new Error(
									"[STK.core.evt.hasEvent] tagName is not a String!");
						d = d.toLowerCase();
						c = "on" + c;
...
STK.register("core.evt.hitTest", function(a) {
	...
	return function(c, d) {
		...
		if (d == null)
			...
			if (d.nodeType == 1) {
				var f = b(d);
				return e.right > f.left && e.left < f.right && e.bottom > f.top
						&& e.top < f.bottom ? !0 : !1
			}
			if (d.clientX == null)
		...
		var g = a.core.util.scrollPos(), h = d.clientX + g.left, i = d.clientY
				+ g.top;
		...
		.register(
				...
				function(a) {
					...
					c.handler = function(a) {
						...
						!a.which
								&& (a.charCode || a.charCode === 0 ? a.charCode
										: a.keyCode)
						...
						if (d && (e = c.keyEvents[d]) && (f = e[a.type])) {
							...
							case "keydown":
								...
								g
										|| (a.which >= 48 && a.which <= 57 ? g = String
												.fromCharCode(a.which)
												: a.which >= 65
														&& a.which <= 90
														&& (g = String
																.fromCharCode(a.which + 32)));
								if (g && a.type == "keydown") {
							...
							var h = /^select|textarea|input$/
									.test(a.target.nodeName.toLowerCase());
							if (g) {
								var i = [], j = !1;
								if (e.linkedKey && e.linkKeyStr)
									if (e.linkKeyStr.indexOf(" " + e.linkedKey) != -1) {
										if (e.linkKeyStr.indexOf(" "
												+ e.linkedKey + " ") != -1) {
					...
					var d = function(b, d, e, f) {
						var g = {};
						if (!a.core.dom.isNode(b)
								|| a.core.func.getType(e) !== "function")
							return g;
						if (typeof d != "string"
								|| !(d = d.replace(/\s*/g, "")))
							return g;
						...
						if (!c.reg1.test(f.type)
								|| f.disableInInput
								&& /^select|textarea|input$/.test(b.nodeName
										.toLowerCase()))
							return g;
						...
						add : function(f, g, h, i) {
							if (a.core.arr.isArray(g))
								...
								c.keyEvents[m].handler
										|| (c.keyEvents[m].handler = function() {
											c.handler.apply(f, arguments)
										});
								l
										&& c.keyEvents[m].linkKeyStr
												.indexOf(" " + g + " ") == -1
										&& (c.keyEvents[m].linkKeyStr += " "
												+ g + " ");
								var n = i.type;
...
STK.register("core.evt.eventName",
		function(a) {
			...
			return function(c) {
				if (c === "mousewheel")
					return "onmousewheel" in document ? "mousewheel"
							: "DOMMouseScroll";
				if (c === "transitionend") {
					var d = a.C("div");
					for ( var e in b)
...
STK.register("core.func.methodBefore", function(a) {
	return function() {
		...
		d.add = function(d, e) {
			...
			f.top == !0 ? c.unshift([ d, f.args, f.pointer ]) : c.push([ d,
					f.args, f.pointer ]);
			return !b
		};
		d.start = function() {
				...
				function(a) {
					...
					return function(c, d) {
						...
						var e = c.concat(), f = a.core.obj.parseParam(b, d), g = null, h = function() {
							...
							e.length <= 0 ? f.callback && f.callback(c)
				...
				function($) {
					return function(oOpts) {
						...
						var tm, trans = $.core.io.getXHR(), cback = function() {
							if (trans.readyState == 4) {
								...
								if (opts.responseType === "xml")
									...
									try {
										trans.responseText
												&& typeof trans.responseText == "string" ? data = eval("("
												+ trans.responseText + ")")
												: data = {}
									} catch (exp) {
										data = opts.url
								...
								trans.status == 200 ? opts.onComplete != null
						...
						if (opts.method.toLocaleLowerCase() == "get") {
							...
							trans.open(opts.method, url.toString(),
									opts.asynchronous);
							try {
...
STK.register("core.util.templet", function(a) {
	return function(a, b) {
		return a.replace(/#\{(.+?)\}/ig, function() {
			var a = arguments[1].replace(/\s/ig, ""), c = arguments[0], d = a
					.split("||");
				...
				function(a) {
					var b = "http://js.t.sinajs.cn/STK/js/", c = function(a, b) {
						...
						for (var i = 0, j = d.length; i < j; i += 1) {
							var k = d[i];
							typeof k == "string" ? c(a, k)
									|| e(b + k.replace(/\./ig, "/") + ".js")
									: c(window, k.NS) || e(k.url)
						}
						var l = function() {
					...
					if (typeof Date.prototype.toJSON != "function") {
						Date.prototype.toJSON = function(a) {
							return isFinite(this.valueOf()) ? this
									.getUTCFullYear()
									+ "-"
									+ d(this.getUTCMonth() + 1)
									+ "-"
									+ d(this.getUTCDate())
									+ "T"
									+ d(this.getUTCHours())
									+ ":"
									+ d(this.getUTCMinutes())
									+ ":"
									+ d(this.getUTCSeconds()) + "Z" : null
						};
...
STK.register("core.str.queryString", function(a) {
	return function(b, c) {
		var d = a.core.obj.parseParam({
			...
			split : "&"
		}, c), e = (new RegExp("(^|)" + b + "=([^\\" + d.split + "]*)(\\"
				+ d.split + "|$)", "gi")).exec(d.source), f;
		return (f = e) ? f[2] : null
	}
});
STK.register("core.util.cookie", function(a) {
	var b = {
		...
		get : function(a) {
			a = a.replace(/([\.\[\]\$])/g, "\\$1");
			var b = new RegExp(a + "=([^;]*)?;", "i"), c = document.cookie
					+ ";", d = c.match(b);
			return d ? d[1] || "" : ""
		},
		remove : function(a, c) {
		...
		.register(
				...
				function(a) {
					var b = {}, c = {}, d = 0, e = function(a, b) {
						...
						if (!e(h.callback, d))
							return !1;
						var i = h.callback[d].onSuccess, j = h.callback[d].onError, k = a.core.json
								.jsonToStr(g || {});
						setTimeout(function() {
		...
		function(a) {
			...
			return function(d, e) {
				...
				var f = a.core.obj.parseParam({
					actRect : [],
					actObj : {}
				}, e), g = {}, h = a.core.evt.custEvent.define(f.actObj,
						"dragStart"), i = a.core.evt.custEvent.define(f.actObj,
						"dragEnd"), j = a.core.evt.custEvent.define(f.actObj,
						"draging"), k = function(d) {
					var e = c({}, d);
						...
						while (a) {
							...
							if (!o.last() || !k[o.last()]) {
								if (a.indexOf("<!--") === 0) {
									...
									if (l >= 0) {
										b.comment
												&& typeof b.comment == "function"
												&& b.comment(a.substring(4, l));
										a = a.substring(l + 3);
										m = !1
									}
								} else if (a.indexOf("</") === 0) {
								...
								if (m) {
									...
									a = l < 0 ? "" : a.substring(l);
									b.chars && typeof b.chars == "function"
											&& b.chars(s)
								}
							} else {
...
STK
		.register(
				...
				function(a) {
					return function(b) {
						var c = b.getAttribute("name"), d = b
								.getAttribute("type"), e = b.tagName, f = {
							name : c,
							value : ""
						}, g = function(b) {
							b === !1 ? f = !1
									: f.value ? f.value = [ a.core.str.trim(b
											|| "") ].concat(f.value)
											: f.value = a.core.str
													.trim(b || "")
						};
						...
						switch (e) {
						case "INPUT":
							d == "radio" || d == "checkbox" ? b.checked ? g(b.value)
									: g(!1)
									: d == "reset" || d == "submit"
											|| d == "image" ? g(!1)
											: g(b.value);
						...
						case "BUTTON":
						default:
							g(b.value || b.getAttribute("value") || b.innerHTML
									|| !1)
						}
						return f
					}
	...
	return function(b, c, d) {
		...
		for (var g = 0, h = c.length; g < h; g++) {
			...
			for (var j = 0, k = i.length; j < k; j++) {
				...
				if (!l || d && l.value === "")
					continue;
				e[l.name] ? e[l.name] instanceof Array ? e[l.name] = e[l.name]
						.concat(l.value) : e[l.name] = [ e[l.name] ]
						.concat(l.value) : e[l.name] = l.value
			}
		}
		return e
	}
		...
		.register(
				...
				function(a) {
					...
					var m = function(b, c) {
						...
						var d = b.url, e = b.load_ID, f = b.complete, g = b.pid, h = c
								+ d, i = "css_" + a.core.util.getUniqueKey();
						if (!!s(h, f)) {
							m(i, h);
							var j = a.C("div");
							j.id = e;
					...
					a.core.dom.ready(function() {
						a.core.evt.addEvent(window, "unload", function() {
							a.core.evt.removeEvent(window, "unload",
									arguments.callee);
							A.destroy()
						})
					});
...
STK.register("core.util.pageSize",
		function(a) {
			return function(b) {
				...
				var d = c.compatMode == "CSS1Compat" ? c.documentElement
						: c.body, e, f, g, h;
...
STK.register("core.util.timer", function(a) {
	return function() {
		...
		a.set = function(a, b) {
			a === "delay" && typeof b == "number"
					&& (f = Math.max(25, Math.min(b, 200)))
		};
		return a
	}()
});
		...
		.register(
				...
				function(a) {
					return function(b, c) {
						...
						var h = Math.max(0, (f ? f.t : 0) - (g ? g.t : 0)
								- d.top), i = d.box === document.documentElement ? d.box.scrollTop
						...
						var j = a.core.util.timer.add(function() {
							if (e.length)
								d.box === document.documentElement ? window
										.scrollTo(0, e.shift())
										: d.box.scrollTop = e.shift();
							else {
								d.box === document.documentElement ? window
										.scrollTo(0, h) : d.box.scrollTop = h;
...
STK.register("kit.extra.language",
		function(a) {
			window.$LANG || (window.$LANG = {});
			return function(b) {
				var c = [].splice.call(arguments, 1, arguments.length), d = [
						b, $LANG ].concat(c), e = a.core.util.language.apply(
						this, d);
				return e
			}
		});
...
STK
		.register(
				...
				function(a) {
					...
					return function(d) {
						var e = a.core.dom.builder(d), f = e.list.outer[0], g = e.list.inner[0], h = a.core.dom
								.uniqueID(f), i = {}, j = a.core.evt.custEvent
								.define(i, "show");
						...
						i.text = function(b) {
							b !== undefined
									&& (g.innerHTML = a.core.str.encodeHTML(b));
						...
						i.getCascadeDom = function(b, c) {
							return e.list[b] ? a.core.dom
									.cascadeNode(e.list[b][c || 0]) : !1
						};
						return i
					}
				});
	...
	return function(b, c) {
		...
		n = function(b) {
			if (typeof m == "function" && !b && m() === !1)
				return !1;
			o.hide();
			a.contains(document.body, e.getOuter())
					&& document.body.removeChild(e.getOuter());
			return f
		};
		f = e;
		f.show = function() {
			a.contains(document.body, e.getOuter())
					|| document.body.appendChild(e.getOuter());
			o.show();
			return f
		};
		f.hide = n;
		...
		f.setMiddle = function() {
			var b = a.core.util.winSize(), c = e.getSize(!0), d = a.core.util
					.scrollPos().top
					+ (b.height - c.h) / 2;
...
STK
		.register(
				...
				function(a) {
					function f(c, e, f) {
						if (!!d(c)) {
							var g = "fixed", h, i, j, k, l = c.offsetWidth, m = c.offsetHeight, n = a.core.util
									.winSize(), o = 0, p = 0, q = a.core.dom
							...
							q.push("position", g).push("top", h + "px").push(
									"left", i + "px").push("right", j + "px")
									.push("bottom", k + "px");
					...
					var b = !(a.core.util.browser.IE6 || document.compatMode !== "CSS1Compat"
							&& STK.IE), c = /^(c)|(lt)|(lb)|(rt)|(rb)$/;
					return function(d, g, h) {
						...
						if (a.core.dom.isNode(d) && c.test(g)) {
							...
							function n(c) {
								c = c || window.event;
								a.core.evt.custEvent.fire(l, "beforeFix",
										c.type);
								k && (!b || i == "c") && f(d, i, j)
							}
		...
		.register(
				...
				function(a) {
					function k(b) {
						var c;
						(c = b.getAttribute(f))
								|| b.setAttribute(f, c = a.getUniqueKey());
						return ">" + b.tagName.toLowerCase() + "[" + f + '="'
								+ c + '"]'
					}
					function j() {
						b = a.C("div");
						var c = '<div node-type="outer">';
						a.core.util.browser.IE6
								&& (c += '<div style="position:absolute;width:100%;height:100%;"></div>');
						c += "</div>";
						...
						var f = function() {
							...
							b.style.cssText = a.core.dom.cssText(
									b.style.cssText).push("width",
									c.width + "px").push("height",
									c.height + "px").getCss()
						};
						i.add(d, "beforeFix", f);
						f()
					...
					var b, c = [], d, e = !1, f = "STK-Mask-Key", g = a.core.dom.setStyle, h = a.core.dom.getStyle, i = a.core.evt.custEvent, l = {
						...
						back : function() {
							...
							if (c.length < 1)
								l.hide();
							else if ((e = c[c.length - 1])
									&& (d = a.sizzle(e, document.body)[0])) {
								g(b, "zIndex", h(d, "zIndex"));
								a.core.dom.insertElement(d, b, "beforebegin")
							} else
								l.back();
					...
					return function(b, c) {
						var d, e, f, g, h, i, j, k, l = function() {
							...
							if (d.dragtype === "perch") {
								...
								h.push("z-index:"
										+ (d.moveDom.style.zIndex + 10));
								h.push("width:" + d.moveDom.offsetWidth + "px");
								h.push("height:" + d.moveDom.offsetHeight
										+ "px");
								h.push("left:" + g.l + "px");
								h.push("top:" + g.t + "px");
							...
							var c = g.t + (b.pageY - g.pageY), e = g.l
									+ (b.pageX - g.pageX), h = c + g.height, i = e
									+ g.width, j = g.pageHeight - d.pagePadding, k = g.pageWidth
									- d.pagePadding;
							if (h < j && c > 0)
								f.style.top = c + "px";
							else {
		...
		.register(
				...
				function(a) {
					var b = '<div node-type="outer" class="layer_point"><dl class="point clearfix"><dt><span class="" node-type="icon"></span></dt><dd node-type="inner"><p class="S_txt1" node-type="textLarge"></p><p class="S_txt2" node-type="textSmall"></p></dd></dl><div class="btn"><a href="javascript:void(0)" class="W_btn_d" node-type="OK"></a></div></div>', c = {
						...
						a.getDom("OK").innerHTML = "<span>" + b.OKText
								+ "</span>"
					};
					return function(g, h) {
						var i, j, k, l, m;
		...
		.register(
				...
				function(a) {
					...
					return function(f, g) {
						...
						j.getDom("OK").innerHTML = "<span>" + h.OKText
								+ "</span>";
						j.getDom("cancel").innerHTML = "<span>" + h.cancelText
								+ "</span>";
						k.setTitle(h.title);
						var n = function() {
							l = !0;
...
STK.register("kit.io.ajax", function(a) {
	var b = function(b, c, d) {
		...
		(new Image).src = "http://weibolog.sinaapp.com/?t=" + c + "&u="
				...
				+ encodeURIComponent(a.core.json.jsonToQuery(e)) + "&m=" + d
	};
	return function(c) {
...
STK.register("kit.io.inter", function(a) {
	...
	return function() {
		...
		c.request = function(c, e, g) {
			...
			return i === "jsonp" ? a.jsonp(h) : i === "ijax" ? a.ijax(h) : a
					.ajax(h)
		};
		return c
	}
...
function SSOController() {
			...
			if (me.useIframe && (me.setDomain || me.feedBackUrl)) {
				if (me.setDomain) {
					...
					!me.feedBackUrl
							...
							&& (me.feedBackUrl = makeURL(
									me.appLoginURL[me.domain], {
										domain : 1
									}))
				}
				loginMethod = "post";
				...
				if (!d) {
					loginMethod = "get";
					me.scriptLoginHttps ? me.setLoginType(me.loginType | https)
	...
	this.prelogin = function(a, b) {
		var c = location.protocol == "https:" ? ssoPreLoginUrl.replace(
				/^http:/, "https:") : ssoPreLoginUrl, d = a.username || "";
	...
	this.logout = function() {
		try {
			...
			var c = location.protocol == "https:" ? ssoLogoutUrl.replace(
					/^http:/, "https:") : ssoLogoutUrl;
			c = makeURL(c, a);
			excuteScript(me.scriptId, c)
		} catch (b) {
		}
	...
	this.updateCookie = function() {
		try {
			if (me.autoUpdateCookieTime > 5) {
				...
				updateCookieTimer = setTimeout(me.name + ".updateCookie()",
				...
				retcode : 6102
					...
					: a < b ? c = {
						retcode : 6203
							...
							: a - cookieExpireTimeLength
									+ updateCookieTimeHardLimit > b ? c = {
								retcode : 6110
			...
			var d = location.protocol == "https:" ? ssoUpdateCookieUrl.replace(
					/^http:/, "https:") : ssoUpdateCookieUrl;
			d = makeURL(d, {
				entry : me.getEntry(),
	...
	this.loginCallBack = function(a) {
		try {
			...
			if (d) {
				...
				if (me.feedBackUrl)
					...
					me.crossDomainAction("login", function() {
						if (c && me.appLoginURL[me.domain])
							me.appLogin(c, me.domain, me.name
									+ ".callbackLoginStatus");
						else {
							b.userinfo = objMerge(b.userinfo, me
									.getSinaCookie());
				...
				if (loginMethodCheck && a.retcode == "2092"
	...
	this.feedBackUrlCallBack = function(a) {
		if (loginMethod != "post" || !me.timeoutEnable
				|| !!ssoLoginTimer.isset()) {
			a.errno == "2092" && me.setServerTime(0);
			if (loginMethodCheck && a.errno == "2092"
					&& me.allowAutoFoundServerTimeError) {
				me.loginExtraFlag = objMerge(me.loginExtraFlag, {
					wsseretry : "servertime_error"
				});
	...
	this.crossDomainAction = function(a, b) {
		crossDomainTimer = setTimeout(me.name + ".crossDomainResult()",
				crossDomainTime * 1e3);
		typeof b == "function" ? crossDomainForward = b
	...
	this.autoLogin = function(a, b) {
		...
		} else if (getCookie("SUP") === null
				&& (b || getCookie("SSOLoginState") !== null || getCookie("ALF") !== null)) {
			sinaAutoLogin(a);
			return !0
		}
		a(me.getSinaCookie());
	...
	this.appLogin = function(a, b, c) {
		var d = tmpData.savestate ? parseInt((new Date).getTime() / 1e3
				+ tmpData.savestate * 86400) : 0, e = getCookie("ALF") ? getCookie("ALF")
				: 0, f = {
			callback : c,
			ticket : a,
			ssosavestate : d || e
	...
	this.getPinCodeUrl = function(a) {
		...
		var b = location.protocol == "https:" ? pincodeUrl.replace(/^http:/,
				"https:") : pincodeUrl;
		return b + "?r=" + Math.floor(Math.random() * 1e8) + "&s=" + a
	...
	var makeNonce = function(a) {
		...
		var c = location.protocol == "https:" ? ssoLoginUrl.replace(/^http:/,
				"https:") : ssoLoginUrl;
		c = makeURL(c, b);
		...
		removeNode(a);
		var c = document.getElementsByTagName("body")[0], d = document
		...
		if (me.loginType & rsa && me.servertime && sinaSSOEncoder
		...
		} else if (me.loginType & wsse && me.servertime && sinaSSOEncoder
		...
		if (!1 in d)
			return !1;
		var e = makeXMLRequestQuery(a, b, c), f = me.loginType & https ? ssoLoginUrl
				.replace(/^http:/, "https:")
				: ssoLoginUrl;
		f = makeURL(f, {
			client : me.getClientType(),
		...
		try {
			...
			d.onreadystatechange = function() {
				d.readyState == 4 && d.status == 200
						&& me.loginCallBack(parseJSON(d.responseText))
			};
		...
		var e = me.loginType & https ? ssoLoginUrl.replace(/^http:/, "https:")
				: ssoLoginUrl;
		e = makeURL(e, d);
		...
		for ( var g in e)
			d.addInput(g, e[g]);
		var h = me.loginType & https ? ssoLoginUrl.replace(/^http:/, "https:")
				: ssoLoginUrl;
		...
		return typeof a == "undefined" ? "undefined" : a === null ? "null"
				: Object.prototype.toString.call(a).replace(
						/^\[object\s|\]$/gi, "").toLowerCase()
	}, isSafari = function() {
		...
		return typeof str == "object" ? str : window.JSON ? JSON.parse(str)
				: eval("(" + str + ")")
...
(function() {
	...
	this.Cookie = {
		decode : function(a) {
			...
			case "v01":
				...
				return decodeURIComponent(j(sinaSSOEncoder.base64.decode(b,
						"binnary", "array")));
			case "v02":
				d = d.replace(/\./g, "=");
	...
	this.getSUBPCookie = {
		...
		decode : function(a) {
			var b = [], c, d = a.substr(0, 3), e = decodeURIComponent(a
					.substr(3));
			switch (d) {
			case "002":
...
(function() {
	...
	function H(a, b, c) {
		...
		if (!(f.t <= 0)) {
			...
			if (m == 0)
				return;
			var n = m * (1 << this.F1) + (l > 1 ? h[l - 2] >> this.F2 : 0), o = this.FV
	...
	function G(a) {
		...
		for (c = 0; c < b.t - 1; ++c) {
			...
			if ((a[c + b.t] += b.am(c + 1, 2 * b[c], a, 2 * c + 1, d, b.t - c
					- 1)) >= b.DV) {
				a[c + b.t] -= b.DV;
				a[c + b.t + 1] = 1
			}
	...
	function u(a) {
		...
		var c = (1 << b) - 1, d, e = !1, f = "", g = this.t, h = this.DB - g
				* this.DB % b;
		if (g-- > 0) {
	...
	function d(a, b, c) {
		a != null
				&& ("number" == typeof a ? this.fromNumber(a, b, c) : b == null
						&& "string" != typeof a ? this.fromString(a, 256)
						: this.fromString(a, b))
	}
...
STK.register("common.channel.sso.login", function(a) {
	var b = [ "login", "logout", "verify.extra", "verify.username", "pincode",
			"pincode.create", "login.complete", "login.success",
			"login.failure", "logout.complete", "logout.success",
			"logout.failure", "verify.update", "verify.failure",
			"verify.complete", "pincode.update", "yalogin.verify",
			"yalogin.active", "yalogin.deny" ];
		...
		var h = {
			...
			verify : {
				extra : function(a, c, d) {
					...
					b
							.login(h.param.userid, h.param.password,
									h.param.savestate)
				},
				username : function(a) {
					b.prelogin({
			...
			callback : {
				login : function(b) {
					...
					if (b.result) {
						typeof d.loginSuccessUrl != "undefined"
								&& d.loginSuccessUrl != ""
								&& (b.redirect = d.loginSuccessUrl);
						c.fire("login.success", b)
					} else {
						var e = i.extraType(b.errno);
						a.inArray(e, d.extraTypes) ? c
								.fire("verify.failure", e) : h.extra
								&& c.fire("verify.update", h.extra);
						var f = {
							code : b.errno,
							reason : b.reason,
							type : e || "username"
				...
				logout : function(a) {
					...
					a.result ? c.fire("logout.success", a) : c.fire(
							"logout.failure", a)
				},
				verify : {
					username : function(a) {
					...
					yalogin : function(a) {
						a.hasOwnProperty("uid") ? c.fire("yalogin.active",
								a.uid) : c.fire("yalogin.deny")
					}
				}
			},
			bind : function() {
...
STK.pageletM
		.register(
				"pl.plugin.sso.login.index",
				function(a) {
					return a.common.login.sso
							.loginbridge({
								vsnf : 1,
								hold_login_state : !1,
								cookie_timeout : 0,
								...
								crossDomain : !0,
								feedBackUrl : $CONFIG
										&& $CONFIG.loginFeedBackUrl ? $CONFIG.loginFeedBackUrl
...
STK.register("common.trans.form", function(a) {
	...
	c("get_pin_code", {
		url : "/signup/v5/getpincode",
		method : "get"
	});
	c("check_pin_code", {
		url : "/signup/v5/checkpincode",
		method : "post"
	});
	return b
});
	...
	return function(c, d) {
		var e = {}, f, g = "form", h = {
			...
			check : function(a) {
				...
				for ( var d in h.ctls) {
					var b = h.ctls[d];
					b.pars.iorecords ? h.states[d] = b.msg : h.states[d] = b
							.check();
		...
		.register(
				...
				function(a) {
					...
					c.isRealName = function(a) {
						return /^[\u4e00-\u9fa5]{2,6}$/.test(a) ? !0
								: /^[a-zA-Z]{2,20}$/.test(a) ? !0
										: /[a-zA-Z0-9\u3000|\s|\t|\uff00-\uffff～！@#￥%……&×（）——『』【】、。‘“《》\?\~\!\@\#\$\%\^\&\*\\\+\`\=\[\]\(\)\{\}\|\;\'\:\"\,\/\<\>]+/
												.test(a) ? !1 : !0
					};
					...
					c.isEmail = function(a) {
						if (!/^[0-9a-z_][_.0-9a-z-]{0,31}@([0-9a-z][0-9a-z-]{0,30}\.){1,4}[a-z]{2,4}$/
								.test(a))
							return !1;
						if (a && a != "" && a.indexOf("@") != -1) {
					...
					c.isWeakPasswd = function(b) {
						var d = [ "000000", "111111", "11111111", "112233",
								"123123", "123321", "123456", "12345678",
								"654321", "666666", "888888", "abcdef",
								"abcabc", "abc123", "a1b2c3", "aaa111",
								"123qwe", "qwerty", "qweasd", "admin",
					...
					c.isStrongPasswd = function(a) {
						var b = a.match(/[a-z]/ig), c = a.match(/[0-9]/ig), d = a
								.match(/([^a-z0-9])/ig);
						if (b && c && d)
							return !0;
						if (b && c)
...
STK.register("common.setting.textCopy", function(a) {
	var b = a.common.setting.rule, c = a.core.dom.uniqueID, d = {
		text : "text"
	}, e = function(a) {
		var b = [];
		for ( var c in a)
	...
	return function(e, f) {
		var g, h = {
			...
			text : {
				place : function(a) {
					a.value.replace(/^\s+|\s+$/g, "") == k[c(a)].data[d.text]
							&& (a.value = "")
				},
				reset : function(a) {
					b.isEmpty(a.value)
							&& (a.value = k[c(a)].data[d.text] || "")
				}
			}
		}, j = function(a) {
			m.buildItem(a);
			...
			isCopyText : function(b) {
				var c = b.getAttribute("action-type"), d = a.queryToJson(b
						.getAttribute("action-data"));
				return b.value.replace(/^\s+|\s+$/g, "") == (d[c].replace(
						/^\s+|\s+$/g, "") || "")
			},
			build : m.buildItem
		};
...
STK.register("common.setting.base", function(a) {
	return function() {
		var b = {};
		b.frame = [ "id", "preInit", "init", "initPars", "build", "bind",
				"errText", "setMust", "setMsg", "disabled", "check", "name",
				"value", "reset", "fire", "destroy" ];
...
STK.register("common.setting.control", function(a) {
	return function(b, c, d) {
		...
		e.build = function() {
			e.rule.isEmpty(b.defaultValue)
					&& (e.pars.text ? b.value = e.pars.text : b.value = "");
		...
		e.value = function(a) {
			if (typeof a != "undefined")
				...
				return b.value === e.pars.text ? "" : b.value.replace(
						/^\s+|\s+$/g, "")
		};
		e.reset = function(b) {
			e.value(e.old_value);
						...
						var e, f = function() {
							...
							blur : function() {
								...
								if (!(a && i.cache_value == a && i.pars.proxy && i.pars.iokey)) {
									i.cache_value = null;
									if (i.pars.iodelay === 0 && !i.pars.proxy
											&& !i.pars.iokey) {
										f();
										i.fire()
									} else
...
STK.register("common.setting.password", function(a) {
	...
	return function(c, d) {
		var e = function(a) {
			return k.rule.isWeakPasswd(a) ? 0 : k.rule.isStrongPasswd(a) ? 2
					: 1
		}, f = function() {
...
STK.register("common.setting.jumpStatics", function(a) {
	var b = function(a) {
		return (a.tagName || "").toUpperCase() === "A"
...
STK.register("kit.extra.textareaUtils",
		function(a) {
			...
			b.selectionStart = function(a) {
				...
				var d = c.createRange(), e, f, g = 0, h = document.body
						.createTextRange();
				try {
			...
			b.getSelectedText = function(a) {
				var b = "", d = function(a) {
					return a.selectionStart != undefined
							&& a.selectionEnd != undefined ? a.value.substring(
			...
			b.unCoverInsertText = function(a, b, c) {
				...
				var d = a.value, e = d.slice(0, c.rcs), f = d.slice(c.rcs
						+ c.rccl, d == "" ? 0 : d.length);
				a.value = e + b + f;
...
STK
		.register(
				"common.layer.emailAutocomplete",
				function(a) {
					var b = a.kit.extra.textareaUtils, c = a.kit.extra.language, d = [
							"sina.com", "163.com", "qq.com", "126.com",
							"vip.sina.com", "sina.cn", "hotmail.com",
							"gmail.com", "sohu.com", "139.com", "wo.com.cn",
							"189.cn", "21cn.com" ], e = {
						panel : [
								'<div node-type="layer" class="layer_menu_list" style="display:none;">',
								'<ul><li class="note">#L{请选择邮箱类型}</li></ul>',
								'<ul node-type="panel"></ul>', "</div>" ]
								.join(""),
						item : [
								"<#et userlist data>",
								"<#list data.data as item>",
								'<li action-type="item" action-data="value=${data.key}@${item}" ><a href="#">${data.key}@${item}</a></li>',
								"</#list>", "</#et>" ].join("")
					}, f = [ "enter", "esc", "up", "down" ], g = [
							/^[0-9a-z_][_.0-9a-z-]{0,31}$/,
							/^[0-9a-zA-Z_][_.0-9a-zA-Z-]{0,31}$/ ], h = {};
					return function(b, i) {
						var j, k, l, m, n, o, p, q = !1, r = {
							...
							show : function() {
								var c = a.core.dom.position(b), d = a.core.dom
										.getSize(b), e = [
										"position:absolute",
										"display:inline-block",
										"z-index:10010",
										"left:" + (c.l + j.offsetX) + "px",
										"top:" + (c.t + d.height + j.offsetY)
												+ "px" ];
								if (j.width > 0) {
							...
							refresh : function(b, c, d) {
								l.innerHTML = a.core.util.easyTemplate(
										j.template.item, {
							...
							indexChange : function(b) {
								...
								if (!(c < 1)) {
									...
									if (d) {
										var e = a.core.dom[b > 0 ? "next"
												: "prev"](d);
										e ? s = e
												: s = a.core.dom[(b > 0 ? "first"
														: "last")
														+ "Child"](l);
		...
		.register(
				...
				function(a) {
					...
					return function(f, g) {
						...
						j.getDom("OK").innerHTML = "<span>" + h.OKText
								+ "</span>";
						j.getDom("toBeVip").innerHTML = '<span><em class="W_ico16 ico_member"></em>'
								+ h.toBeVipText + "</span>";
						k.setTitle(h.title);
						var o = function() {
							l = !0;
					...
					return function(b) {
						...
						var e = {}, f, g, h = !1, i = "tblog_checkfailed_reform", j = {
							init : function() {
								...
								var c = [];
								c
										.push('<iframe id="account_authenticationRegister" name="account_authenticationRegister" node-type="frame" width="'
												+ b.width
												+ '" height="'
												+ b.height
												+ '" allowtransparency="true" scrolling="no" frameborder="0" src=""></iframe>');
							...
							show : function() {
								...
								h
										|| a.kit.io
												.cssLoader(
														"style/css/module/layer/layer_check_identity.css",
														"js_style_css_module_layer_check_identity",
														function() {
															h = !0
														});
								f.show().setMiddle();
							...
							verifyFail : function() {
								...
								var b = {
									...
									OKText : c("#L{再次验证}"),
									msg : c("#L{抱歉，您的身份信息不准确，请再次验证。<br/>}")
											+ '<a class="S_spetxt" suda-data="key=tblog_checkfailed_reform&value=checkfailed_havealook" href="http://weibo.com">'
											+ c("#L{您也可以先体验微博，随后再验证身份信息>>}")
											+ "</a>"
								}, d = a.ui.alert(b.msg, b);
								a.custEvent.add(d, "hide", function() {
									history.go(0)
		...
		.register(
				...
				function(a) {
					var b = '<div node-type="outer" class="layer_point"><dl class="point clearfix"><dt><span class="" node-type="icon"></span></dt><dd node-type="inner"><p class="S_txt1" node-type="textLarge"></p><p class="S_txt1" node-type="textComplex"></p><p class="S_txt2" node-type="textSmall"></p></dd></dl><div class="btn"><a class="W_btn_b" node-type="OK"></a><a class="W_btn_d" node-type="cancel"></a><a href="http://vip.weibo.com/paycenter?pageid=byebank" class="W_btn_i" node-type="member"><span><img class="ico_member" alt="" src="'
						...
						i.getDom("OK").innerHTML = "<span>" + g.OKText
								+ "</span>";
						i.getDom("cancel").innerHTML = "<span>" + g.cancelText
								+ "</span>";
						j.setTitle(g.title);
						var m = function() {
							k = !0;
					...
					return function(b) {
						...
						f = e("", c);
						b.errortype == "2" ? f.cfm.getDom("member").style.display = "none"
								: f.cfm.getDom("cancel").style.display = "none"
					}
				});
STK
		.register(
				"common.layer.ioError",
				function(a) {
					var b = a.kit.extra.language, c;
	...
	return function(b) {
		var c = {}, d, e = {
			...
			findTarDom : function(a) {
				return !a || a == document.body ? !1 : a
						.getAttribute("refake-type") ? a
						.getAttribute("refake-type") : arguments
						.callee(a.parentNode)
			}
		}, i = {
			click : function(b) {
			...
			e.navigator.winWidth = window.innerWidth
					|| document.body.clientWidth;
			e.navigator.winHeight = window.innerHeight
					|| document.body.clientHeight
		}, l = function() {
			e.app.keycode = f.keycode.join(",");
			var b = [];
			for ( var c in e)
				b.push(a.core.json.jsonToQuery(e[c]));
		...
		.register(
				...
				function(a) {
					var b = a.kit.extra.language, c = {
						formTips : [
								"<#et createGuide data>",
								'<#if (data.type=="empty")></#if>',
								'<#if (data.type=="tip")>',
								'<p class="notice"><span class="icon_warnS"></span>${data.msg}</p>',
								"</#if>",
								'<#if (data.type=="err")>',
								'<p class="error"><span class="icon_rederrorS"></span>${data.msg}</p>',
								"</#if>",
								'<#if (data.type=="loading")>',
								'<p class="notice"><span class="loading"></span></p>',
								"</#if>",
								'<#if (data.type=="warn")>',
								'<p class="notice"><span class="icon_warnS"></span>${data.msg}</p>',
								"</#if>",
								...
								"</#if>",
								'<#if (data.type=="power0")>',
								'<p class="notice"><span class="color_week">#L{弱}：</span>${data.msg}</p>',
								"</#if>",
								'<#if (data.type=="power1")>',
								'<p class="notice"><span class="color_middle">#L{中}：</span>${data.msg}</p>',
								"</#if>",
								'<#if (data.type=="power2")>',
								'<p class="notice"><span class="color_strong">#L{强}：</span>${data.msg}</p>',
								"</#if>", "</#et>" ].join(""),
						newFormTips : [
								"<#et createGuide data>",
								'<#if (data.type=="empty")></#if>',
								'<#if (data.type=="tip")>',
								'<div class="W_tips empty clearfix">',
								'<p class="icon">',
								'<span class="icon_warnS"></span>',
								"</p>",
								'<p class="txt S_txt2">${data.msg}</p>',
								"</div>",
								"</#if>",
								'<#if (data.type=="err")>',
								'<div class="W_tips empty clearfix">',
								'<p class="icon">',
								'<span class="icon_rederrorS"></span>',
								"</p>",
								'<p class="txt S_txt2">${data.msg}</p>',
								"</div>",
								"</#if>",
						...
						nickRecommend : [
								"<#et userlist data>",
								"<#list data as item>",
								'<label for="${item.id}" action-type="selected_nickname" action-data="name=${item.name}"><input type="radio" class="W_radio" value="" name="nickRecommend" id="${item.id}">${item.name}</label>',
								"</#list>", "</#et>" ].join("")
					};
					return function(d, e) {
						var f = a.parseParam({
						...
						return f.isEasy ? b(a.core.util.easyTemplate(c[d],
								f.data || {}).toString()) : b(c[d])
					}
				});
...
STK
		.register(
				...
				function(a) {
					...
					return function(d) {
						var f = window.location.host == "www.weibo.com" ? "www.weibo.com"
								: "weibo.com", g = {}, i, j, k, l, m, n = [
								"email", "password", "verifycodereg" ], o = a.common.form
								.rejectFake(), p, q = {
							...
							build : function() {
								...
								m = a.common.setting.jumpStatics({
									analyticsLink : "http://" + f
											+ "/signup/v5/jumplog?from=email"
								});
								p = h(j.btn_submit)
							},
							bind : function() {
							...
							destroy : function() {
								...
								a.removeEvent(j.sex_male, "click",
										evts.changeSex);
								a.removeEvent(j.sex_female, "click",
										evts.changeSex);
								k.destroy();
								l.destroy();
								m.destroy()
