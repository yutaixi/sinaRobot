 ...
 var sinaRegEncoder = sinaRegEncoder || {};
  (function() {
		function bt(a) {
		...
		if (c && "Microsoft Internet Explorer" == "Microsoft Internet Explorer") {
			d.prototype.am = g;
			a = 30
		} else if (c && "Microsoft Internet Explorer" != "Netscape") {
			d.prototype.am = f;
			a = 26
		} else {
			d.prototype.am = h;
...
function getPassEncoding(pubKey, serverTime, nonce,password) { 
	  debugger;
	    sinaRegEncoder.setPublic(pubKey,  "10001"); 
	    return sinaRegEncoder.encrypt(password); 
}
