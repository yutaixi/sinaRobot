...
public class SimHash {
    ...
    public BigInteger simHash() {
        ...
        while (stringTokens.hasMoreTokens()) {
            ...
            BigInteger t = this.hash(temp,this.hashbits);
    ...
    public static String getSimHash(String str,int hashbits)
    {
        ...
        while (stringTokens.hasMoreTokens()) {
            String temp = stringTokens.nextToken();
            BigInteger t = SimHash.hash(temp,hashbits);
    ...
    public static void main(String[] args) {
        ...
        SimHash hash1 = new SimHash(s, 80);
        ...
        SimHash hash2 = new SimHash(s, 80);
        System.out.println(hash2.intSimHash+ "  " + hash2.intSimHash.bitCount());
        hash1.subByDistance(hash2, 3);
        s = "This is a test string for testing als";
        SimHash hash3 = new SimHash(s, 80);
